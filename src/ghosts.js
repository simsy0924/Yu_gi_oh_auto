...
export function validateStep(step) {
  ...
  if(selectionRequests.has(step.on)&&step.indices===undefined&&!(step.card!==undefined&&['SELECT_CARD','SELECT_TRIBUTE'].includes(step.on)))throw new Error(`${step.on}: 선택 대상 번호 또는 카드 번호를 입력하세요.`);
