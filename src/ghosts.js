...
export const actionsByRequest={
  SELECT_IDLECMD:['summon','special','position','set','set-spell','activate','battle','end','shuffle'],
  SELECT_BATTLECMD:['activate','attack','main2','end'],
  SELECT_CHAIN:['activate','pass'],
  SELECT_EFFECTYN:['yes','no'],SELECT_YESNO:['yes','no'],
  SELECT_UNSELECT_CARD:['select','unselect','finish','cancel'],
  SELECT_OPTION:[],SELECT_POSITION:[],SELECT_CARD:[],SELECT_TRIBUTE:[],
  SELECT_PLACE:[],SELECT_DISFIELD:[],SELECT_SUM:[],SELECT_COUNTER:[],
  SORT_CARD:[],SORT_CHAIN:[],ANNOUNCE_RACE:[],ANNOUNCE_ATTRIB:[],ANNOUNCE_CARD:[],
  ANNOUNCE_NUMBER:[],ROCK_PAPER_SCISSORS:[]
};
export const selectionRequests=new Set(['SELECT_CARD','SELECT_TRIBUTE','SELECT_PLACE','SELECT_DISFIELD','SELECT_SUM','SORT_CARD','SORT_CHAIN','ANNOUNCE_RACE','ANNOUNCE_ATTRIB','ANNOUNCE_CARD']);
